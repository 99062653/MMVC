...
define('DB_NAME', 'manegeSQL'); // Wat is de database naam
define('DB_USER', 'managebeheer'); 		// Wat is de database gebruiker
define('DB_PASS', 'wuXRD7lpRVdUGNVR');		// Wat is het database wachtwoord
...
define('DEFAULT_CONTROLLER', ''); 			// Dit is de standaard controller waarmee de webapplictie wordt opgestart
